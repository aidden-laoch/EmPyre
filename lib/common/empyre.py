...
import sys, cmd, MySQLdb, os, hashlib, traceback, time
...
class MainMenu(cmd.Cmd):
    ...
    def __init__(self, args=None, restAPI=False):
        ...
        # Bring in the TeamPire settings
        #self.teamserver = 
        #self.tport = 
    ...
    def database_connect(self):
        try:
            ...
            self.conn = MySQLdb.connect(host='localhost',user='empyre-balls',passwd='4zballs',db='empyre')
